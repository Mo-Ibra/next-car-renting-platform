    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* Left Banner */}
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-400 to-blue-500 p-8 min-h-[400px]">
                ...
                {/* Right Banner */}
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-700 p-8 min-h-[400px]">
                    <div className="relative z-10">
                        <h2 className="text-4xl font-bold text-white mb-4 max-w-[300px]">Easy way to rent a car at a low price</h2>
                        <p className="text-white/90 mb-6 max-w-[300px]">
                            Providing cheap car rental services and safe and comfortable facilities.
                        </p>
                        <Button className="bg-blue-400 hover:bg-blue-500 text-white" size="lg">
                            Rental Car
                        </Button>
                    </div>
